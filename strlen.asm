...
strlen:
    mov rcx, 0          ; Set RCX à 0
    jmp looping         ; On exécute la boucle du strlen

looping:
    cmp BYTE [rdi], 0   ; rdi == string, [] permet de déréférencer, 0 limite == '\0'
    ...
    mov rax, rcx        ; On bouge la valeur de RCX dans RAX
    ret                 ; Return de RAX